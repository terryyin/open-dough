...
Installed Open Dough skills live under `.agents/skills/`. Closing a completed
story or bounded correction after its plan execution and retrospective uses the
installed wrap-up skill.

Additional human input is in `HUMAN.md` when that file is present.
