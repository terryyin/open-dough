#!/usr/bin/env bash
# Credential-free proof that Codex delivery/updated-use keeps update then use
# as one retained journey: real fixture apply, no refusal, no retry.
# shellcheck disable=SC2016,SC2312 # Literal invocation marker; pipefail covers listings.
set -euo pipefail
