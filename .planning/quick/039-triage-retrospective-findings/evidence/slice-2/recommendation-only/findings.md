...
Fictional ranking fixture for Quick 039 slice 1. Identities `ODF-901`,
`ODF-902`, and `ODF-903` are walkthrough-only; they are not allocated in the
...
- Execution: `fixture:slice-1-ranking / wrap-up-overwrite @ fict-aaa111`
  - Tool: Cursor
...
- Execution: `fixture:slice-1-ranking / extra-prompt-a @ fict-bbb222`
  - Tool: Cursor
  - Model: test-model-ranking
  - Open Dough release: unreleased
...
- Execution: `fixture:slice-1-ranking / extra-prompt-a @ fict-bbb222`
  ...
  - Model: test-model-ranking
  - Open Dough release: unreleased
  - Evidence: later rereport of the same execution in `extra-prompt-a-reread.md`
  - Observed effect: the same extra confirmation on the same execution is
    described again
  - Inference: repeating the report does not establish a second execution
- Execution: `fixture:slice-1-ranking / extra-prompt-b @ fict-ccc333`
  - Tool: Codex
  - Model: test-model-ranking
  - Open Dough release: unreleased
