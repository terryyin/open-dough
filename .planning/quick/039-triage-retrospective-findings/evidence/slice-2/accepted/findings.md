...
Fictional selected-proposal fixture for Quick 039 slice 2. Identities
...
- Execution: `fixture:slice-2-starting / wrap-up-overwrite @ fict-aaa111`
  - Tool: Cursor
  - Model: test-model-slice-2
...
Follow-up: queued, not resolved. [Prevent wrap-up from overwriting a reviewed execution commit](seeds/SEED-901-process-follow-up.md#prevent-wrap-up-from-overwriting-reviewed-commits) — SEED-901.
...
- Execution: `fixture:slice-2-starting / extra-prompt-a @ fict-bbb222`
  - Tool: Cursor
  - Model: test-model-slice-2
  - Open Dough release: unreleased
  ...
  - Inference: a default confirmation gate is a likely cause; cost is the delay
    only
- Execution: `fixture:slice-2-starting / extra-prompt-b @ fict-ccc333`
  - Tool: Codex
  - Model: test-model-slice-2
  - Open Dough release: unreleased
