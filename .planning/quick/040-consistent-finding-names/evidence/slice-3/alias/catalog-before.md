...
- **References:** representative record for execution `Quick 034 / 7650585` at Open Dough release 0.3.4; continuity 0.3.4 (`e0af631`, tag v0.3.4) → assessed 0.3.6 (`f8c2033`, tag v0.3.6); remaining issue `skills/recover-execution/SKILL.md` recovery section still omits a compact reviewed manifest
