...
- **References:** representative record `records/similar-symptom.md` (S1–S3); source log `similar-symptom/DearDough.md`; execution `record:quick-036-slice-2`; matching uncertainty versus ODF-001 — similar rereading symptoms, shared cause not established; not continuity and not a demonstrated correction
