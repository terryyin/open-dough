...
# A tab-suffixed managed command is classified as this same conflict (R6);
# install-ci-host-hooks.sh observes that classification, and the conflict
# path above observes the equal-version refusal.
