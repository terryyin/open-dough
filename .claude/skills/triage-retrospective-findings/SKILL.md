...
This file is a Claude Code discovery entry only. Read and follow the canonical skill at `.agents/skills/triage-retrospective-findings/SKILL.md`. Do not use a separate procedure.
