...
# Portable unsupported children, even when the runner itself uses modern Bash.
# Bash 4 is refused too: the runner reads EPOCHREALTIME, which Bash 5 added.
for version in '3.2.57(1)-release' '4.4.23(1)-release'; do
