...
- Execution: `SEED-037#quiet-stable-four-times-faster-tests` / plan 096, first related implementation commit `0fdf13c`
  ...
  - Model: claude-opus-5-5[1m]
  - Open Dough release: 0.3.39
  - Evidence: plan 096 Outside-in proof "Machine" bullet and "Comparable measurement (relative)"; the unpaired baseline under load 54–66 read 664.9 s where the paired start revision read 242.6 s.
