...
Five occurrences (plans 089, 092, 096, 097 twice) are pruned; see Retention.
...
## DD-103 — A host permission check refused maintainer-approved test removals relayed to an agent
...
## DD-104 — Full-suite proof in a checkout another agent was editing reported false failures
...
## DD-105 — A checkpoint stop offered unranked options, and the maintainer could not choose
...
## DD-106 — A delegated implementation agent handed back before finishing its own required proof
